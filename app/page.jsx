...
export default function Home() {
  return  <div className="mt-40">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {statsData.map((statsData, index)=>(
            <div key={index} className="text-center">
              <div className="text-4xl font-bold text-gray-800 mb-2">{statsData.value} </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuresData.map((feature,index) => (
            <Card key={index} className= "p-6">
             ...
             {feature.icon}
             <h3 className="space-y-4 pt-4">{feature.title}</h3>
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">Our User's Experience</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <section className="py-20 bg-gray-600">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
          Join thousands of users who are already managing their financies smarter with Fintech.
        </p>
        <Link href="/dashboard">
            <Button
              size="lg"
